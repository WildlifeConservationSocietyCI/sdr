...
class Command(BaseCommand):
    ...
    def handle(self, *args, **options):
        ...
        new_aws_key_name = '%s/db_backup_%s.%s' % (self.backup, simpleflake(), BACKUP_EXTENSION)
        new_backup_filename = '%s_db_backup_%s.%s' % (self.backup, simpleflake(), BACKUP_EXTENSION)
    ...
    def _pg_dump(self, filename):
        ...
        self._run(dump_command, to_file='/tmp/sdr/stdout_backup.log')
        print('Dump Complete!')
